...
(function(global) {
	...
	Temporal["prototype"]["getScore"] = getScore;         // Temporal#getScore(void):number
	Temporal["prototype"]["importVector"] = importVector; // Temporal#importVector(vector:string):this
	Temporal["prototype"]["getVector"] = getVector;       // Temporal#getVector(void):string
	...
	function getVector(base) {
		...
		if (!isNull(base)) {
			...
			vector = 'CVSS:3.0'; //prefix for CVSSv3
